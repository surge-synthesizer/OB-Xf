...
{
static const juce::String Undefined{"Undefined"};
static const juce::String SelfOscPush{"Filter Push"};
...
static const juce::String FourPole{"4-Pole"};
...
static const juce::String Multimode{"Multimode"};
static const juce::String LfoSampleHoldWave{"LFO S&H"};
static const juce::String LfoSineWave{"LFO Sine"};
static const juce::String LfoSquareWave{"LFO Square"};
static const juce::String LfoAmount1{"LFO Mod Amount 1"};
static const juce::String LfoAmount2{"LFO Mod Amount 2"};
...
static const juce::String Attack{"Amp Attack"};
static const juce::String Decay{"Amp Decay"};
static const juce::String Sustain{"Amp Sustain"};
static const juce::String Release{"Amp Release"};
