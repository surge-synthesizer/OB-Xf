...
namespace SynthParam {
    namespace ID {
        ...
        static const juce::String PitchQuant{"PitchQuant"};
    ...
    namespace Name {
        static const juce::String Undefined{"Undefined"};
        static const juce::String SelfOscPush{"Self Oscillator Push"};
        static const juce::String EnvPitchBoth{"Envelope Pitch Both"};
        static const juce::String FenvInvert{"Filter Envelope Invert"};
        static const juce::String PwOsc2Ofs{"PW Offset"};
        static const juce::String LevelDif{"Level Difference"};
        static const juce::String PwEnvBoth{"PW Envelope Both"};
        static const juce::String PwEnv{"PW Envelope"};
        static const juce::String LfoSync{"LFO Sync"};
        static const juce::String EconomyMode{"Economy Mode"};
        static const juce::String MidiUnlearn{"MIDI Unlearn"};
        static const juce::String MidiLearn{"MIDI Learn"};
        static const juce::String VAmpFactor{"Velocity Amp Factor"};
        static const juce::String VFltFactor{"Velocity Filter Factor"};
        static const juce::String AsPlayedAllocation{"As Played Allocation"};
        static const juce::String VibratoRate{"Vibrato Rate"};
        static const juce::String FourPole{"Four Pole"};
        static const juce::String LegatoMode{"Legato Mode"};
        static const juce::String EnvelopeToPitch{"Envelope To Pitch"};
        static const juce::String PitchQuant{"Pitch Quantization"};
        static const juce::String VoiceCount{"Voice Count"};
        static const juce::String BandpassBlend{"Bandpass Blend"};
        static const juce::String FilterWarm{"Filter Warm"};
        static const juce::String BendRange{"Bend Range"};
        static const juce::String BendOsc2Only{"Bend Osc 2 Only"};
        static const juce::String Octave{"Octave"};
        static const juce::String Tune{"Tune"};
        static const juce::String Brightness{"Brightness"};
        static const juce::String NoiseMix{"Noise Mix"};
        static const juce::String Osc1Mix{"Oscillator 1 Mix"};
        static const juce::String Osc2Mix{"Oscillator 2 Mix"};
        static const juce::String Multimode{"Multimode"};
        static const juce::String LfoSampleHoldWave{"LFO Sample & Hold Wave"};
        static const juce::String LfoSineWave{"LFO Sine Wave"};
        static const juce::String LfoSquareWave{"LFO Square Wave"};
        static const juce::String LfoAmount1{"LFO Amount 1"};
        static const juce::String LfoAmount2{"LFO Amount 2"};
        static const juce::String LfoFilter{"LFO Filter"};
        static const juce::String LfoOsc1{"LFO Oscillator 1"};
        static const juce::String LfoOsc2{"LFO Oscillator 2"};
        static const juce::String LfoFrequency{"LFO Frequency"};
        static const juce::String LfoPw1{"LFO PW 1"};
        static const juce::String LfoPw2{"LFO PW 2"};
        static const juce::String PortamentoDetune{"Portamento Detune"};
        static const juce::String FilterDetune{"Filter Detune"};
        static const juce::String EnvelopeDetune{"Envelope Detune"};
        static const juce::String Pan1{"Pan 1"};
        static const juce::String Pan2{"Pan 2"};
        static const juce::String Pan3{"Pan 3"};
        static const juce::String Pan4{"Pan 4"};
        static const juce::String Pan5{"Pan 5"};
        static const juce::String Pan6{"Pan 6"};
        static const juce::String Pan7{"Pan 7"};
        static const juce::String Pan8{"Pan 8"};
        ...
        static const juce::String Portamento{"Portamento"};
        static const juce::String Unison{"Unison"};
        static const juce::String FilterKeyFollow{"Filter Key Follow"};
        ...
        static const juce::String Volume{"Volume"};
        static const juce::String VoiceDetune{"Voice Detune"};
        static const juce::String Oscillator2detune{"Oscillator 2 Detune"};
        static const juce::String Cutoff{"Cutoff"};
        static const juce::String Resonance{"Resonance"};
    ...
    namespace Ranges {
        ...
        static const juce::String Off{"Off"};
    }
