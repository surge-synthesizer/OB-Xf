  ...
  private:
                                ...
                                const float newValue)
    {
        ...
        static const std::unordered_map<std::string, Handler> handlers = {
            ...
            {LevelSlop, [](SynthEngine &s, float v) { s.processAmpSlop(v); }},
            ...
            {Lfo1ModAmt1, [](SynthEngine &s, float v) { s.processLfoAmt1(v); }},
            {Lfo1ModAmt2, [](SynthEngine &s, float v) { s.processLfoAmt2(v); }},
            ...
            {Lfo1ToFilterCutoff, [](SynthEngine &s, float v) { s.processLfoFilter(v); }},
            {Lfo1ToOsc1Pitch, [](SynthEngine &s, float v) { s.processLfoOsc1(v); }},
            {Lfo1ToOsc2Pitch, [](SynthEngine &s, float v) { s.processLfoOsc2(v); }},
            {Lfo1ToOsc1PW, [](SynthEngine &s, float v) { s.processLfoPw1(v); }},
            {Lfo1ToOsc2PW, [](SynthEngine &s, float v) { s.processLfoPw2(v); }},
            {Lfo1ToVolume, [](SynthEngine &s, float v) { s.processLfoVolume(v); }},
            {Lfo1PW, [](SynthEngine &s, float v) { s.processLfoPulsewidth(v); }},
            ...
            {AmpEnvAttack, [](SynthEngine &s, float v) { s.processAmpEnvelopeAttack(v); }},
            {AmpEnvDecay, [](SynthEngine &s, float v) { s.processAmpEnvelopeDecay(v); }},
            {AmpEnvSustain, [](SynthEngine &s, float v) { s.processAmpEnvelopeSustain(v); }},
            {AmpEnvRelease, [](SynthEngine &s, float v) { s.processAmpEnvelopeRelease(v); }},
