...
static const juce::String LevelDetune{"LevelSlop"};
...
static const juce::String EnvelopeToPWInv{"EnvelopeToPWInv"};
...
static const juce::String RingModMix{"RingModMix"};
static const juce::String NoiseMix{"NoiseMix"};
static const juce::String NoiseColor{"NoiseColor"};
...
static const juce::String LfoPulsewidth{"LfoPW"};
static const juce::String LfoPw1{"LfoPW1"};
static const juce::String LfoPw2{"LfoPW2"};
static const juce::String LfoVolume{"LfoVolume"};
...
static const juce::String LevelDetune{"Level Slop"};
...
static const juce::String EnvelopeToPWInv{"Invert Filter Env to PW"};
...
static const juce::String RingModMix{"Ring Mod Mix"};
static const juce::String NoiseMix{"Noise Mix"};
static const juce::String NoiseColor{"Noise Color"};
...
static constexpr float LevelDetune{0.0f};
...
static constexpr float EnvelopeToPWInv{0.0f};
...
static constexpr float NoiseColor{0.0f};
static constexpr float RingModMix{0.0f};
static constexpr float Multimode{0.0f};
static constexpr float LfoSineWave{0.f};
static constexpr float LfoSquareWave{0.5f};
static constexpr float LfoSampleHoldWave{0.5f};
...
static constexpr float LfoPulsewidth{0.0f};
static constexpr float LfoPw1{0.0f};
static constexpr float LfoPw2{0.0f};
static constexpr float LfoVolume{0.0f};
