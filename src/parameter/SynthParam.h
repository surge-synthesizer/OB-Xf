...
static const std::string VoiceCount{"VoiceCount"};
static const std::string BandpassBlend{"BandpassBlend"};
static const std::string FilterWarm{"Filter_Warm"};
...
static const std::string LfoSampleHoldWave{"LfoSampleHoldWave"};
static const std::string LfoSineWave{"LfoSineWave"};
static const std::string LfoSquareWave{"LfoSquareWave"};
...
static const std::string VoiceCount{"Polyphony"};
...
static const std::string LfoSampleHoldWave{"LFO S&H Wave"};
static const std::string LfoSineWave{"LFO Sine Wave"};
static const std::string LfoSquareWave{"LFO Square Wave"};
