...
static const std::string LfoModAmt1{"LfoModAmt1"};
static const std::string LfoModAmt2{"LfoModAmt2"};
static const std::string LfoToFilterCutoff{"LfoToFilterCutoff"};
static const std::string LfoToOsc1Pitch{"LfoToOsc1Pitch"};
static const std::string LfoToOsc2Pitch{"LfoToOsc2Pitch"};
static const std::string Lfo1Rate{"Lfo1Rate"};
static const std::string LfoPulseWidth{"LfoPW"};
static const std::string LfoToOsc1PW{"LfoPW1"};
static const std::string LfoToOsc2PW{"LfoPW2"};
static const std::string LfoToVolume{"LfoToVolume"};
...
static const std::string Lfo1TempoSync{"LFO Tempo Sync"};
static const std::string Lfo1Wave1{"LFO Wave 1"};
static const std::string Lfo1Wave2{"LFO Wave 2"};
static const std::string Lfo1Wave3{"LFO Wave 3"};
static const std::string LfoModAmt1{"LFO Mod 1 Amount"};
static const std::string LfoModAmt2{"LFO Mod 2 Amount"};
static const std::string LfoToFilterCutoff{"LFO to Filter Cutoff"};
static const std::string LfoToOsc1Pitch{"LFO to Osc 1 Pitch"};
static const std::string LfoToOsc2Pitch{"LFO to Osc 2 Pitch"};
static const std::string Lfo1Rate{"LFO Rate"};
static const std::string LfoPulseWidth{"LFO Pulsewidth"};
static const std::string LfoToOsc1PW{"LFO to Osc 1 PW"};
static const std::string LfoToOsc2PW{"LFO to Osc 2 PW"};
static const std::string LfoToVolume{"LFO to Volume"};
