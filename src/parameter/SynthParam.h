...
static const std::string Lfo2ModAmt1{"Lfo2ModAmt1"};
static const std::string Lfo2ModAmt2{"Lfo2ModAmt2"};
...
static const std::string Lfo2ModAmt1{"LFO 2 Mod 1 Amount"};
static const std::string Lfo2ModAmt2{"LFO 2 Mod 2 Amount"};
