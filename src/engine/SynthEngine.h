...
#define ForEachVoice(expr)                                                                         \
    ...
    void procPitchBendUpRange(float param) { ForEachVoice(pitchWheelUpAmt = param * MAX_BEND_RANGE); }
    void procPitchBendDownRange(float param) { ForEachVoice(pitchWheelDownAmt = param * MAX_BEND_RANGE); }
