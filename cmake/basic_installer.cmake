...
if (APPLE)
    ...
    add_custom_command(
            ...
            COMMAND ${CMAKE_SOURCE_DIR}/libs/sst/sst-plugininfra/scripts/installer_mac/make_installer.sh "OB-Xf-Banks" ${OBXF_PRODUCT_DIR} ${CMAKE_SOURCE_DIR}/resources/installer_mac ${CMAKE_BINARY_DIR}/installer "${OBXF_DATE}-${GIT_COMMIT_HASH}" "${CMAKE_SOURCE_DIR}/assets/installer"
    )
elseif (WIN32)
    ...
    if (TARGET innosetup::compiler)
        ...
        add_custom_command(
                ...
                /O"${CMAKE_BINARY_DIR}/installer" /F"${OBXF_INSTALLER}" /DName="${TARGET_BASE}-Banks"
                /DNameCondensed="${TARGET_BASE}-Banks" /DVersion="${GIT_COMMIT_HASH}"
